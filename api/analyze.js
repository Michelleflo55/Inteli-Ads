...
CRITICAL HOOK RULE: Never mention competitor names in any hook or script. Hooks must stand alone without referencing other brands. The brand competes on its own merits.

GENDER RULE: Personas must match the actual target customer gender for this brand. A mens health brand gets male personas with 'why he buys'. A womens brand gets female personas with 'why she buys'. A unisex brand gets mixed. Infer the correct gender from the brand name and product category.';

  const userMessage = 'Brand: ' + brand + '\nData:\n' + context + '\n\nNegative hook frameworks: ' + negativeHookFrameworks + '\nCuriosity hook frameworks: ' + curiosityHookFrameworks + '\nPersona hook frameworks: ' + personaHookFrameworks + '\n\nReturn this exact JSON structure with real data filled in:\n{\n  "topHeadlines": ["5 specific hooks for this brand"],\n  "painPoints": ["5 pain points in exact Reddit language"],\n  "valueProps": ["5 value props with specific mechanism"],\n  "topTopics": ["5 content topics resonating now"],\n  "topKeywords": ["12 exact consumer words"],\n  "hookPatterns": ["3 hook structures with full example lines"],\n  "redditInsights": ["6 direct Reddit quotes or close paraphrases"],\n  "competitorAngles": ["5 angles competitors are running"],\n  "competitorAdaptations": ["5 competitor angles that could work for this brand"],\n  "competitorKeywords": ["10 keywords competitors target"],\n  "competitorGaps": ["5 untapped angles this brand could own"],\n  "personas": [\n    {"type":"proven","identity":"4-6 words who she is","description":"2 sentences her daily life","why_they_buy":"specific moment they try this. Use correct gender pronoun for this brand.","hook":"first ad line max 12 words","angle":"how product fits her life","redditQuote":"real reddit quote"},\n    {"type":"proven","identity":"...","description":"...","why_they_buy":"...","hook":"...","angle":"...","redditQuote":"..."},\n    {"type":"proven","identity":"...","description":"...","why_they_buy":"...","hook":"...","angle":"...","redditQuote":"..."},\n    {"type":"whitespace","identity":"underserved woman","description":"her life why ads miss her","why_they_buy":"specific trigger","hook":"hook for her","angle":"why untapped","redditQuote":""},\n    {"type":"whitespace","identity":"...","description":"...","why_they_buy":"...","hook":"...","angle":"...","redditQuote":""}\n  ],\n  "hooksNegative": ["5 negative hooks filled in for this brand. Use the negative frameworks. Fill all blanks with brand-specific language. NEVER mention competitor names."],\n  "hooksCuriosity": ["5 curiosity hooks filled in for this brand. Use curiosity frameworks. Fill all blanks. NEVER mention competitor names."],\n  "hooksPersona": ["5 persona hooks filled in for this brand. Use persona frameworks. Fill all blanks. NEVER mention competitor names."],\n  "hooksTrending": ["[Confession] example hook", "[POV] example hook", "[Reaction] example hook", "[Before After] example hook", "[List] example hook"],\n  "scriptRecommendation": "Single highest-leverage script angle. 3 sentences max."\n}';

  try {
    // Validate inputs
    if (typeof brand !== 'string') return res.status(400).json({ error: 'Invalid brand: ' + typeof brand });
    if (typeof rawData !== 'object') return res.status(400).json({ error: 'Invalid rawData: ' + typeof rawData });
